...
echo -e "\n=================================="
echo "1LVL-asciigrid2postgis"
echo -e "==================================\n"
echo -e "Batch import of a folder containing multiple ASCII Grid Files to a PostGIS database.\n"
echo "FOLDER"
echo "   |-asciigrid 1.1"
echo "   |-asciigrid 1.2"
echo "   |-asciigrid 1.n"
...
deftilesize=auto
read -p "2.- Set TILE_SIZE is expressed as WIDTHxHEIGHT or set to the value 'auto' to allow the loader to compute an appropriate value (e.g. 100x100): " -i "$deftilesize" -e TILE_SIZE
